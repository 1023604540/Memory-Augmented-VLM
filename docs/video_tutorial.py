...
pretrained = "/hkfs/work/workspace/scratch/tum_tyz7686-LLaVA-OV/checkpoints/llava-onevision-0.5b-qwen2_KIT_position_8tokens_lowerLR_30-60"
...
question = f"{DEFAULT_IMAGE_TOKEN}\n A hand comes out of the computer, what dis the hand do?\n"
