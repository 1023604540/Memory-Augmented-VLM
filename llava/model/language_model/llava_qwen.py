    ...
    def generate(
        ...
        **kwargs,
        ...
        if images is not None:
            (memory_prompt, inputs, position_ids, attention_mask, _, inputs_embeds, _) = self.prepare_inputs_labels_for_multimodal(memory_prompt, inputs, position_ids, attention_mask, None, None, images, modalities, image_sizes=image_sizes)
        else:
