...
class EpisodicMemoryController:
    def __init__(self, mem_slots=32, mem_patch=196, mem_dim=1024):
        # Initialize memory matrices (keys and values could be same in this simple case)
        self.mem_keys = torch.zeros((mem_slots, mem_patch, mem_dim))
        self.mem_vals = torch.zeros((mem_slots, mem_patch, mem_dim))
