...
PREV_STAGE_CHECKPOINT="/hkfs/work/workspace/scratch/tum_tyz7686-LLaVA-OV/checkpoints/llava-onevision-0.5b-larimar_videollamb_KIT_position__checkpoint-800" # replace it with your last checkpoint training from single image collection
